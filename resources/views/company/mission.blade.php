							...
							<div class="col-xs-9 s-pad">
								<div class="company-main">
									...
									<div class="body c-sdark f-14" style="padding-right:15px;">
										<h5 class="c-bright-green f-20 mb-5">Mission</h5>
										<p class="lh-17">{{$company->mission}}</p><br>
										
										<h5 class="c-bright-green f-20 mb-5">Vision</h5>
										<p class="lh-17">{{$company->vision}}</p><br>

										<h5 class="c-bright-green f-20 mb-5">Goal</h5>
										<p class="lh-17">{{$company->goals}}</p><br>
